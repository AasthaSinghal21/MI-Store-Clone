...
const PreNavbar = () => {
  return (
    ...
    <div>
      ...
      <a href = "https://store.mi.com/in/site/login?redirectUrl=https%3A%2F%2Fwww.mi.com%2Fin%2F&scene=register">SIGN UP</a> <span> | </span>
      <a href = "https://store.mi.com/site/login"> {cartIcon}Cart (0)</a>
    </div>
    </div>
